...
first_cycling_calendar_df = pd.read_csv(setwd+'first_cycling_calendar_df.csv')
...
cci_output = pd.read_csv(setwd+'cycling_chaos_ingestion_df.csv')['output'].to_list()
cci_output_details = pd.read_csv(setwd+'cycling_chaos_ingestion_df.csv')['output_details'].to_list()
cci_file_name = pd.read_csv(setwd+'cycling_chaos_ingestion_df.csv')['file_name'].to_list()

# print(first_cycling_stage_races_race_id_list)
...
for calendar_df_stage_races_race_id_extract in tqdm(range(0,
    ...
    cci_output_details.append('stage_profiles')
...
cycling_chaos_ingestion.to_csv(setwd+'cycling_chaos_ingestion_df2.csv', index=False)
